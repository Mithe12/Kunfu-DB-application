...
import kunfuclub.DbClass.Student.*;
...
public class StudentHistory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dhid = new javax.swing.JTextField();
        ...
        jLabel1.setText("Create Student History");
        ...
        PaidDate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PaidDateActionPerformed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(Reason, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(PaidDate, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(223, 223, 223))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(198, 198, 198)
        ...
        jTabbedPane1.addTab("Create History", jPanel1);

        jLabel15.setFont(new java.awt.Font("Dialog", 3, 24)); // NOI18N
        jLabel15.setText("Update History");
        ...
        jLabel24.setText("Enter The History  ID to be Edited:");
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(Reas, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jTabbedPane1.addTab("Update History", jPanel2);

        jLabel13.setFont(new java.awt.Font("Dialog", 3, 24)); // NOI18N
        jLabel13.setText("Delete Particular History");

        jLabel14.setText("History ID");

        dhid.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                dhidActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(34, 34, 34)
                .addComponent(dhid, javax.swing.GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE)
                .addGap(269, 269, 269))
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGap(291, 291, 291)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel14)
                    .addComponent(dhid, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(DeleteParent)
                .addContainerGap(317, Short.MAX_VALUE))
        );

        jTabbedPane1.addTab("Delete History", jPanel3);
        ...
        jTabbedPane1.addTab("View History", jPanel4);

        jLabel11.setFont(new java.awt.Font("Dialog", 3, 24)); // NOI18N
        jLabel11.setText("View Student History");
        ...
        jTabbedPane1.addTab("View Student History", jPanel5);

        jButton1.setText("Main Scrren");
    ...
    private void getparentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getparentActionPerformed
        ...
        List<history> parnts;
        parnts = histryDao.getUserHistory(Integer.parseInt(viewparentID.getText()));
        if (parnts != null) {
            parnts.stream().map((students) -> 
                    " ID: " + students.getId()
                + ", Reason: " + students.getReason()
                + ", Paid:" + students.getPaid()
                + ", Paid Date: " + students.getPaid_date()
    ...
    private void getAllparentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getAllparentActionPerformed
        ...
        List<history> parnts;
        parnts = histryDao.getAllHistory();
        if (parnts != null) {
            parnts.stream().map((students) -> 
                    " ID: " + students.getId()
                + ", Reason: " + students.getReason()
    ...
    private void DeleteParentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteParentActionPerformed
        histryDao.deleteHistory(Integer.parseInt(dhid.getText()));
    }//GEN-LAST:event_DeleteParentActionPerformed

    private void dhidActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dhidActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_dhidActionPerformed

    private void uSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_uSubmitActionPerformed

        history students = histryDao.getHistory(Integer.parseInt(usid.getText()));
        UStudent_ID.setText(String.valueOf(students.getHisfk_sid()));
        Reas.setText(students.getReason());
        paid.setText(String.valueOf(students.getPaid()));
        paiddate.setText(String.valueOf(students.getPaid_date()));
    ...
    private void uUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_uUpdateActionPerformed
        ...
        history ustudent = histryDao.getHistory(Integer.parseInt(usid.getText()));
        ustudent.setReason(Reas.getText());
        ustudent.setPaid(Float.parseFloat(paid.getText()));
        ustudent.setPaid_date(Date.valueOf(paiddate.getText()));
        histryDao.updateHistory(ustudent);
    }//GEN-LAST:event_uUpdateActionPerformed

    private void paiddateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_paiddateActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_paiddateActionPerformed
    ...
    private void PSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PSaveActionPerformed
        ...
        nstudent = new history(
            Reason.getText(), 
            (float) Double.parseDouble(Paid.getText()),
            Date.valueOf(PaidDate.getText()),
            
            Integer.parseInt(Student_ID.getText())
        );
        histryDao.addHistory(nstudent);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentHistory().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField dhid;
